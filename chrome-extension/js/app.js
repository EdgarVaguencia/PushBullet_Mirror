...
},{"../models/push":3,"backbone":5}],2:[function(require,module,exports){
var Backbone = require('backbone'),
...
},{"./routers/router":8,"backbone":5,"backbone.paginator":4,"jquery":6}],3:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../collections/push":1,"../models/push":3,"../views/pushes":10,"../views/signin":11,"backbone":5,"jquery":6,"underscore":7}],9:[function(require,module,exports){
var Backbone = require('backbone'),
...
module.exports = Backbone.View.extend({
  ...
  render : function(){
    ...
    html += ' /><h1>'+push.push.title+'</h1><p class="pushBody">'+push.push.body+'</p><p class="details"><span class="application">'+push.push.application_name+'</span><span class="date">'+push.created+'</span><span class="actions"><a href="#" id="actions_' + push.push.notification_id + '">Delete</a></span></p>';
    this.$el.html(html);
    return this;
  },
...
module.exports = Backbone.View.extend({
  ...
  viewTimeLine : function(){
    ...
    $(".actions a").click(function(){
      var notification_id = this.id.replace('actions_','');
      var pushes = JSON.parse(localStorage.pushes);
      var commit = false;
      $.each(pushes, function(k,i){
        if(i.push.notification_id==notification_id){
          pushes.splice(i, 1);
          commit = true;
          return false;
        }
      ...
      if(commit){
        $($(this).parents()[2]).hide(500, function(){
          $(this).remove();
        });
